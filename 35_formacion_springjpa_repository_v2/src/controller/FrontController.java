	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(option) {
			...
			case "doMatricular":
				...
				url="menu.html";
				break;
			case "doConsultarMatriculas":
				request.getRequestDispatcher("MatriculasRangoAction").include(request, response);
				url = "verMatriculasRango.jsp";
				break;
			case "toConsultarMatriculas":
				url = "verMatriculasRango.jsp";
				break;
			case "toAltaAlumno":
				url="altaAlumno.html";
