...
@NamedQuery(name="Inscripcion.findByNombreEmpresa", query="SELECT i FROM Inscripcion i WHERE i.empresa = ?1")
@NamedQuery(name="Inscripcion.findByEmpresa", query="SELECT DISTINCT i.empresa FROM Inscripcion i")
