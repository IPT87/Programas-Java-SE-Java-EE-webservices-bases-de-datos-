...
/**
 * Servlet implementation class VerMovimientosAction
 */
@WebServlet("/VerMovimientosAction")
public class VerMovimientosAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("movimientos", service.movimientos(numeroCuenta));
