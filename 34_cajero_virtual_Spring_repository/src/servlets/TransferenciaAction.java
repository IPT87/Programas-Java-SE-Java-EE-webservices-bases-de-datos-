...
public class TransferenciaAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int numeroCuentaOrigen = (int)request.getSession().getAttribute("numeroCuenta");
		int numeroCuentaDestino = Integer.parseInt(request.getParameter("cuentaDestino"));
		request.setAttribute("resultado", service.transferencia(numeroCuentaOrigen, numeroCuentaDestino, cantidad));
	}
