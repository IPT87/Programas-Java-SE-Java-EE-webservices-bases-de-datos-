...
public class Registrar extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Candidato> listaCandidatos = (List<Candidato>) context.getAttribute("candidatos");
		
		Candidato candidato = new Candidato(nombre, edad, puesto, nombreFichero);
		
		synchronized (listaCandidatos) {
			listaCandidatos.add(candidato);
		}
		
		guardarFicheroEnServidor(request, foto, nombreFichero);
		
		context.setAttribute("candidatos", listaCandidatos);
